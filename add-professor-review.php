 ...
 * Script to authenticate and add professor review to the database.
 * Users will be allowed to add multiple professor reviews as long as
 * the course associated with the reviews are different.
 */
