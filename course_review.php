...
<table style="float:center">
	...
	<tr>
		...
		<table>
		<tr>
			<td><input type='text' id='course' name='course' placeholder='Course' required></td>
			<td><input type='text' id='professor' name='professor' placeholder='Professor' required></td>
		</tr>
		</table>
		</td>
	</tr>
